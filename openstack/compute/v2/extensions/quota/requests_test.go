...
var ExpectedQuotaSetSlice []QuotaSet
...
func TestList(t *testing.T) {
	...
	err := List(client.ServiceClient()).EachPage(func(page pagination.Page) (bool, error) {
		count++
		actual, err := ExtractQuotaSets(page)
		th.AssertNoErr(t, err)
		th.CheckDeepEquals(t, ExpectedQuotaSetSlice, actual)
...
func TestCreate(t *testing.T) {
	...
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, &CreatedQuota, actual)
}
...
func TestImport(t *testing.T) {
	...
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, &ImportedQuota, actual)
}
